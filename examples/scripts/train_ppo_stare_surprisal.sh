...
# GRPO + STARE surprisal-guided advantage reweighting
# (https://arxiv.org/abs/2606.19236)
# Flags entropy-critical (high-surprisal) tokens via batch-internal surprisal
# quantiles and amplifies their effective advantage to slow policy entropy
# collapse during long-horizon RLVR training. The reweighting step is
# default-off; the --algo.advantage.surprisal_reweight flag below enables it.
...
python3 -m openrlhf.cli.train_ppo_ray \
   ...
   --algo.advantage.surprisal_reweight_quantile 0.8 \
   --algo.advantage.surprisal_reweight_factor 1.5 \
